...
class SettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['setting_group' => 'expenses', 'setting_key' => 'approval_threshold_amount', 'setting_value' => '100', 'value_type' => 'integer', 'description' => 'Expenses above this amount require expenses.approve to record, or are recorded as pending until approved.'],
